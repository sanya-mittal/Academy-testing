...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_17'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/textarea_Comments_oxd-textarea oxd-textarea_6464fb'), 'leave test')
